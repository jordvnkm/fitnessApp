...
user7 = Api::User.create(username: "Lauren Thompson", password: "password7", email: "user7@gmail.com" , home_location_id: 62, profile_img_url: "http://cdn.techpp.com/wp-content/uploads/2012/12/fitness-juice.jpg")
...
user13 = Api::User.create(username: "Fatima Aquilar", password: "password3", email: "user13@gmail.com", home_location_id: 62, profile_img_url: "http://content.active.com/Assets/Active.com+Content+Site+Digital+Assets/Running/620/Long+Run+620.jpg")
...
user23 = Api::User.create(username: "Hilary Swatkins", password: "password3", email: "user23@gmail.com", home_location_id: 59, profile_img_url: "https://www.sharedteams.com/img/case-studies/fitness-service-graphic.jpg")
...
user24 = Api::User.create(username: "Eugene Curry", password: "password4", email: "user24@gmail.com", home_location_id: 62, profile_img_url: "http://greatist.com/sites/default/files/styles/big_share/public/LoseFitness-feature.jpg?itok=hbb6EL8A")

user25 = Api::User.create(username: "Ben Sampson", password: "password5", email: "user25@gmail.com", home_location_id: 62, profile_img_url: "http://images.military.com/media/military-fitness/army-physical-fitness-program-image-ts600.jpg")
# user26 = Api::User.create(username: "Serena Wilmington", password: "password6", email: "user26@gmail.com", home_location_id: 68, profile_img_url: "http://www.ew.com/sites/default/files/i/2015/07/11/serena-williams.jpg")
user26 = Api::User.create(username: "Serena Wilmington", password: "password6", email: "user26@gmail.com", home_location_id: 68, profile_img_url: "http://enforma.salud180.com/sites/default/files/styles/medium/public/field/image/2014/11/tendencias_fitness_en_2015.jpg?itok=wsYb-VYY")

user27 = Api::User.create(username: "Joe Ross", password: "password7", email: "user27@gmail.com", home_location_id: 49, profile_img_url: "https://static.pexels.com/photos/17840/pexels-photo.jpg")
...
user31 = Api::User.create(username: "Grace Cole", password: "password1", email: "user31@gmail.com", home_location_id: 36, profile_img_url: "https://media3.popsugar-assets.com/files/2012/07/28/4/192/1922729/55cba752738b2490_118387116.preview.jpg")
user32 = Api::User.create(username: "Klay Jackson", password: "password2", email: "user32@gmail.com", home_location_id: 37, profile_img_url: "https://www.nerdfitness.com/wp-content/themes/NerdFitness/library/images/steve_hero_lrg.png")
